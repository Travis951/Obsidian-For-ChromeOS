(()=>{
    ...
    function t() {
        ...
        Object.each || (Object.each = function(t, e, n) {
            for (var r in t)
                if (t.hasOwnProperty(r) && !1 === e.call(n, t[r], r))
                    return !1;
            return !0
        }
        ),
        ...
        function c(t) {
            var e = this.style;
            for (var n in t)
                t.hasOwnProperty(n) && e.setProperty(n, t[n])
        }
        ...
        Node.prototype.insertAfter = function(t, e) {
            return e ? this.insertBefore(t, e.nextSibling) : this.insertBefore(t, this.firstChild),
            t
        }
        ,
        ...
        HTMLElement.prototype.hide || (HTMLElement.prototype.hide = function() {
            ...
            "none" !== t && (this.style.display = "none",
            t ? this.setAttribute("data-display", t) : this.removeAttribute("data-display"))
        }
        ),
        ...
        Element.prototype.findAllSelf = function(t) {
            ...
            return this.matches(t) && e.unshift(this),
            e
        }
        ,
        ...
        window.createSvg = function(t, e, n) {
            ...
            var i = e || {}
              ...
              , p = i.parent
              , c = i.prepend;
            return s && (Array.isArray(s) ? (r = o.classList).add.apply(r, s) : o.classList.add(s)),
            a && o.setAttrs(a),
            n && n(o),
            ...
            if (i) {
                ...
                s && (i[t] = s.filter((function(i) {
                    if (i.selector === e && i.listener === n && i.options === r) {
                        var s = i.callback;
                        return o.removeEventListener(t, s, r),
                        !1
                    }
                    return !0
                }
        ...
        HTMLElement.prototype.onNodeInserted = function(t, e) {
            var n = this
              , r = function(r) {
                n.isShown() && (e && o(),
                "node-inserted" === r.animationName && t())
            }
              , o = function() {
                n.removeEventListener("animationstart", r);
                var t = (f.get(n) || 0) - 1;
                t <= 0 ? (f.delete(n),
                n.removeClass("node-insert-event")) : f.set(n, t)
            };
            return f.set(this, (f.get(this) || 0) + 1),
        ...
        window.ajax = function(t) {
            ...
            s)
                for (var c in s)
                    s.hasOwnProperty(c) && p.setRequestHeader(c, s[c]);
            p.withCredentials = a || !1,
            i ? (void 0 === a && (p.withCredentials = !0),
            String.isString(i) ? p.send(i) : i instanceof ArrayBuffer ? (p.setRequestHeader("Content-Type", "application/octet-stream"),
            p.send(i)) : (p.setRequestHeader("Content-Type", "application/json; charset=utf-8"),
            p.send(JSON.stringify(i)))) : p.send()
        }
        ,
